...
function Main(){
  const _1=Doc.Element("div", [Attr.Create("class", "min-h-screen bg-gray-900 text-white flex flex-col items-center p-6")], [Doc.Element("h1", [Attr.Create("class", "text-4xl font-bold mb-8")], [Doc.TextNode("ReDice \ud83c\udfb2")]), Doc.Element("div", [Attr.Create("class", "bg-gray-800 p-6 rounded-2xl w-full max-w-md")], [Doc.Element("p", [Attr.Create("class", "text-sm text-gray-400 mb-2")], [Doc.TextNode("Dice Type")]), Doc.Element("select", [Attr.Create("class", "mb-4 w-full bg-gray-700 p-3 rounded-xl text-white")], ofSeq(delay(() => map(diceTypeOption, diceTypes())))), Doc.Element("p", [Attr.Create("class", "text-sm text-gray-400 mb-2")], [Doc.TextNode("Number of Dice")]), Doc.Element("select", [Attr.Create("class", "mb-6 w-full bg-gray-700 p-3 rounded-xl text-white")], ofSeq(delay(() => map(diceCountOption, diceCounts())))), Doc.Element("button", [Attr.Create("class", "w-full py-3 bg-purple-600 rounded-xl hover:bg-purple-700 font-semibold")], [Doc.TextNode("ROLL DICE")])]), Doc.Element("div", [Attr.Create("class", "mt-10 text-center")], [Doc.Element("p", [Attr.Create("class", "text-gray-400")], [Doc.TextNode("Last Roll")]), Doc.Element("h2", [Attr.Create("class", "text-5xl font-bold mt-2")], [Doc.TextNode("30")]), Doc.Element("p", [Attr.Create("class", "text-gray-500 mt-2")], [Doc.TextNode("20 + 10")])])]);
  LoadLocalTemplates("");
  Doc.RunById("main", _1);
}
